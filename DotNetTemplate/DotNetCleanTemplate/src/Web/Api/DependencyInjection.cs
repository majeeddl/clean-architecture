    ...
    public static class DependencyInjection
    {
        ...
        public static IServiceCollection AddSwaggerOptions(this IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Version = "v1",
                    Title = "DotNetCleanTemplate.WebUI",
        ...
        public static IApplicationBuilder UseAppSwagger(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "DotNetCleanTemplate.WebUI v1");
                options.SwaggerEndpoint("/swagger/v2/swagger.json", "DotNetCleanTemplate.WebUI v2");
